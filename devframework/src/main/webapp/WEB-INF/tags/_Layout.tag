<!DOCTYPE html>
<%@tag description="Virtual Lab" pageEncoding="UTF-8"%>
		...
		<header>
			<div class="navbar navbar-dark bg-dark box-shadow">
				<div class="container d-flex justify-content-between">
					<a href="./" class="navbar-brand d-flex align-items-center font-esfinge">
					<img alt="Esfinge Framework Logo" src="${pageContext.request.contextPath}/resources/images/esfinge_logo2.png">&ensp;<strong>Esfinge Virtual Lab</strong>
					</a>
