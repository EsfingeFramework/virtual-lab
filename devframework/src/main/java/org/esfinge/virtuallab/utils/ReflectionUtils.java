...
public class ReflectionUtils {
    ...
    public static Method getMethod(MethodDescriptor methodDescriptor) throws Exception {
        ...
        var clazz = findClass(methodDescriptor.getClassName());
        ...
        for (var m : clazz.getMethods()) {
            if (m.getName().equals(methodDescriptor.getName())
                ...
                var found = true;
                for (var p : methodDescriptor.getParameters()) {
    ...
    /**
     * Retorna os tipos concretos de uma classe que implementa/estende uma interface generica. Funciona somente para as
     * classes que implementam/estendem a interface generica no codigo fonte, e nao em tempo de execucao:
     *
     * Funciona: - interface Generica<E, F>
    ...
    public static List<Class<?>> getActualTypesFromGenericInterface(Class<?> genericInterface, Class<?> concreteClass) {
        ...
        for (var type : concreteClass.getGenericInterfaces()) {
            if (type instanceof ParameterizedType) {
                ...
                if (pType.getRawType() == genericInterface) {
                    ...
                    for (var actType : pType.getActualTypeArguments()) {
    ...
    /**
     * Retorna os tipos concretos de uma classe que estende uma classe generica. Funciona somente para as classes que
     * estendem a classe generica no codigo fonte, e nao em tempo de execucao:
     *
     * Funciona: - class Generica<E, F>
    ...
    public static List<Class<?>> getActualTypesFromGenericClass(Class<?> concreteClass) {
        ...
        var type = concreteClass.getGenericSuperclass();
