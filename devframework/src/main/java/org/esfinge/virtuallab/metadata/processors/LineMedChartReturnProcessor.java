...
public class LineMedChartReturnProcessor extends MethodReturnProcessor<LineChartReturn>
{
	@Override
	...
	{
		List<DatasetObject> datasetList = new ArrayList<LineMedChartReturnProcessor.DatasetObject>();
				...
				if (! Utils.isNullOrEmpty(xArr)&&! Utils.isNullOrEmpty(yArr) )
				{
					for ( int i = 0; i < xArr.size(); i++ )
					{
						...
						{	
							...
							org.esfinge.virtuallab.metadata.processors.LineMedChartReturnProcessor.Data data = new org.esfinge.virtuallab.metadata.processors.LineMedChartReturnProcessor.Data();
