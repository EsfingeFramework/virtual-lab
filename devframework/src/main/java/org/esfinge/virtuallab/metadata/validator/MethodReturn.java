...
/**
 * Utilizado nas anotacoes que renderizam o retorno de metodos, como por exemplo @TableReturn. Nao pode exister mais do
 * que um renderizador de retorno para um metodo.
 */
