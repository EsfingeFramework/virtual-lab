...
public class TableReturnProcessor extends MethodReturnProcessor<TableReturn> {
    ...
    public JsonData process(Object value) throws Exception {
        // objeto de retorno
        var returnObj = new TableReturnObject();
        ...
        if (!Utils.isNullOrEmpty(value)) {
            ...
            // tipo dos objetos
            var clazz = collection.get(0).getClass();
            ...
            var headers = this.annotation.headerLabels().length == fields.length
            ...
            for (Object obj : collection) {
                ...
                for (var fieldName : returnFields) {
