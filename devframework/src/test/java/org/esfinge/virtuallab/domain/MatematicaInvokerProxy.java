...
public class MatematicaInvokerProxy {
    ...
    public double calcularDistanciaProxy(
            @Param(label = "Ponto A", fields = {
        @ParamAttribute(name = "x", label = "Coordenada X"),
        @ParamAttribute(name = "y", label = "Coordenada Y")}) Ponto p1,
            @Param(label = "Ponto B", fields = {
        @ParamAttribute(name = "x", label = "Coordenada X"),
        @ParamAttribute(name = "y", label = "Coordenada Y")}) Ponto p2) {
