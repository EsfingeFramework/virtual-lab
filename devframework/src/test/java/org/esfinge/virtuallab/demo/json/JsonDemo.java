...
public class JsonDemo {
    ...
    public String getNomeDisciplina(String codigo) {
        var d = this.getDisciplina(codigo);
    ...
    private Disciplina getDisciplina(String codigo) {
        for (var disciplinas : disciplinas_2019.values()) {
            var disciplina = Utils.getFromCollection(disciplinas, d -> d.getCodigo().equalsIgnoreCase(codigo));
            if (disciplina != null) {
                return disciplina;
            }
        }
