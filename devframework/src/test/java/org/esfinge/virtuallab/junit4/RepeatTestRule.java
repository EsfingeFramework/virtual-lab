...
/**
 * Permite a repeticao de testes no JUnit4. Baseado em: https://github.com/cbismuth/junit-repeat-rule
 */
public class RepeatTestRule implements TestRule {
    ...
    public Statement apply(Statement statement, Description description) {
        ...
        var repeat = description.getAnnotation(RepeatTest.class);
        if (repeat != null) {
            var times = repeat.times();
            var verbose = repeat.verbose();
